...
function Signup() {
  ...
  let [data, setData] = useState({ name: "", username: "", phone: "" });
  let handleInput=(e)=>{
  ...
  return (
    <div className="container mt-11 p-5" style={{width:"20rem",backgroundColor:"rgb(16, 8, 61)"}}>
      <form>
        ...
        <div class="form-group mb-3">
          <label for="exampleInputPassword1" style={{color:"white"}}>Phone Number</label>
          <input
            type="text"
            class="form-control"
