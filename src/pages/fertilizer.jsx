...
const Fertilizer = () => {
    ...
    const cropToBeGiven = a.selectedPlant.charAt(0) + a.selectedPlant.slice(1);
    ...
    return (
        <div className='h-full w-full p-2'>
            ...
            {/* <h1 className='text-primary mb-2 text-5xl font-medium leading-tight'>Fertilizer</h1> */}
            <h1 className='text-primary mb-2 text-5xl font-medium leading-tight'>Fertilizer</h1>
            <div>
                <h3 className='text-primary mb-2 mt-3 text-3xl font-medium leading-tight'>Unit</h3>
            ...
            <div>
                ...
                <div className='flex flex-col justify-center'>
                    <div className='flex justify-center mb-8'>
                        ...
                        <div className='bg-slate-100 rounded-lg w-[8rem] text-primary pt-2 ml-2 mr-2 text-3xl font-medium leading-tight text-center'> {plotSize} </div>
            ...
            <div>
                <h3>Below are the recommendations of fertilizers to you can select for this crop</h3>
                {
                    data.map((item) => {
                        return (
